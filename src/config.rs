...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk(鍵彣資訊興業社專用版，無法與外部版本互聯)".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["helpdesk.mingstudio.me"];
pub const RS_PUB_KEY: &str = "iCFhSikSeHPeWnC28sXYyWXQbjMGS8uIRoPPfI5BdTY=";
